...
describe 'catalog_url' do
  ...
  it { is_expected.to run.with_params('10.14').and_return('/content/catalogs/others/index-10.14-10.13-10.12-10.11-10.10-10.9-mountainlion-lion-snowleopard-leopard.merged-1') }
end
